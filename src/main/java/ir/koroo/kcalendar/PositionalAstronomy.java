...
public abstract class PositionalAstronomy {
    ...
    public final double j2000 = 2451545.0;

    // Days in Julian century
    public final double julianCentury = 36525.0;

    // Days in Julian millennium
    public final double julianMillennium = (julianCentury * 10);

    // Astronomical unit in kilometres
    public final double astronomicalUnit = 149597870.0;

    // Mean solar tropical year
    public final double tropicalYear = 365.24219878;

        /*  ASTOR  --  Arc-seconds to radians.  */

    protected double astor(double a) {
    ...
    protected double rtd(double r) {
        return (r * 180.0) / Math.PI;
    }

        /*  FIXANGLE  --  Range reduce angle in degrees.  */

    protected double fixangle(double a) {
        return a - 360.0 * (Math.floor(a / 360.0));
    }

        /*  FIXANGR  --  Range reduce angle in radians.  */

    protected double fixangr(double a) {
    ...
    private final double[][] jde0Tab1000 =
    ...
    private final double[][] jde0Tab2000 =
   ...
   Meeus, "Astronomical Algorithms", first edition. */
    ...
    protected double[] ecliptoeq(double jd, double Lambda, double Beta) {
        double eps;
        double Ra;
        double Dec;
    ...
    protected double deltat(double year) {
        double dt;
        double f;
        double t;
        int i;
    ...
    protected double equinox(double year, int which) {
    ...
    protected double[] sunpos(double jd) {
    ...
    protected double equationOfTime(double jd) {
